...
<blockquote class="text-xl italic font-semibold text-gray-900 dark:text-white blockquote-con">
    ...
    <p>“Freshness is happiness, and we deliver both.”</p>
</blockquote>

 <section class="bg-white dark:bg-gray-900 blog-sec">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
          <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white blog-title">SnapIt's Teams</h2>
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400 blog-p">“With just a snap, your order is placed — fresh products delivered fast, at the best price.”</p>
      </div> 
      <div class="grid gap-8 lg:grid-cols-3 blog-grid">
          <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <div class="flex justify-between items-center mb-5 text-gray-500">
                  ...
                  <span class="text-sm">4 days ago</span>
              </div>
